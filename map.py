...
class Map:
    ...
    def __init__(self, width, height):
        ...
        for region_idx in range(self.num_regions):
            self.region_boundaries.append(self.get_region_boundary(region_idx))
    ...
    def check_adjancent_regions(self, rid_1, rid_2):
        ...
        '''
        bound_rid1 = self.region_boundaries[rid_1-1]
        bound_rid2 = self.region_boundaries[rid_2-1]
        for x1, y1 in bound_rid1:
            for x2, y2 in bound_rid2:
                if (
                    [x1+1,y1] == [x2,y2]
                    or [x1-1,y1] == [x2,y2]
                    or [x1,y1+1] == [x2,y2]
